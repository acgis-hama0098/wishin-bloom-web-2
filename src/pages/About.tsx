  ...
  return (
    <>
      <SEO
        title="About Us"
        description="Learn about our story, passion for event planning, and commitment to creating memorable celebrations. From handmade gifts to full event coordination, we bring love to every detail."
       keywords="handmade gifts Ottawa, handmade decor, Christmas gifts, Communion gifts, Tooth Fairy gifts, handmade rosaries, retractable badge reels, badge reel clickers, handmade keychains, handmade greeting cards, handmade bookmarks, resin crafts, handmade ornaments, gift sets, personalized gifts, Canadian handmade gifts" />
      ...
      <div className="about">
        <section className="section bg-[#a7e3d8]">
          <div className="container bg-[#a7e3d8]/[0.84]">
            <div className="about-hero">
              <h1>The Heart Behind the Handmade</h1>
              <p className="lead font-bold">
                We believe every moment deserves to be celebrated with love, care, and attention to detail.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="story-grid">
              <div className="story-text">
                ...
                <p className="text-justify">
                  Since as far back as I can remember, I’ve been creating handmade gifts, party favors, invitations, and decorations for life’s special moments. What began as a passion soon became something more especially when my tiny helper, my daughter, joined me. With her innocent creativity and curious heart, she helped bring our shared vision to life. Together, we poured love into every piece, making each item not just beautiful, but meaningful.

                  This work did more than fill our days  it strengthened the bond between us. Through the art of creation, we built not just a small business, but a life filled with joy, laughter, and connection. As a single mother, raising my only daughter came with challenges. But what kept us grounded and grateful was the happiness we were able to share with others. Our clients welcomed us into their most cherished moments: weddings, baptisms, birthdays, and more. Some even invited us to their celebrations, turning strangers into friends and work into lasting memories.

                  These experiences carried us through the hardest of times and became the foundation of our story.
                </p>

                <p className="text-justify">
                  Nature has always been a gentle guide in our creative journey. The colors, textures, and harmony of the natural world inspire everything we make. We are friendly users of what nature offers always with respect, care, and a heart for sustainability.

                  Beyond our love for design, we believe in giving back. Our small business proudly contributes to the community by supporting people with disabilities, offering them opportunities to work with us in ways that honor their abilities and dignity.

                  Every item we make carries a story: ours, and now, yours. Thank you for letting us be a part of your beautiful moments.
                </p>
              </div>

              <div className="story-images">
                <img src="/images/about/img1.jpg" alt="Crafting memories together" />
                {/* <img src="/images/about/img2.jpg" alt="Joyful celebration prep" />
                <img src="/images/about/img3.jpg" alt="Handmade gifts with love" /> */}
              </div>
            </div>
          </div>
        </section>
